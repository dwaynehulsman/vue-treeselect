  ...
  methods: {
    ...
    normalize: function normalize(parentNode, nodes, prevNodeMap) {
      ...
      var normalizedOptions = nodes.map(function (node) {
        ...
        _this16.$set(normalized, "color", color);

        _this16.$set(normalized, "backgroundColor", backgroundColor);
...
/* harmony default export */ var MultiValueItemvue_type_script_lang_js_ = ({
  ...
  computed: {
    color: function color() {
      ...
      return (_this$node$color = this.node.color) !== null && _this$node$color !== void 0 ? _this$node$color : null;
    },
    backgroundColor: function backgroundColor() {
      var _this$node$background;

      return (_this$node$background = this.node.backgroundColor) !== null && _this$node$background !== void 0 ? _this$node$background : null;
    },
